...
class __TwigTemplate_88c12eadc787b9c4f852a3161a1a88ed extends Template
{
...
$context["subItem"], "type", [], "any", false, false, false, 58) == "header")) {
                    // line 59
                    yield "                    ";
                    yield $this->env->getRuntime('Symfony\UX\TwigComponent\Twig\ComponentRuntime')->render("ea:ActionMenu:ActionList:Header", ["label" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(CoreExtension::getAttribute($this->env, $this->source, $context["subItem"], "content", [], "any", false, false, false, 59)), "renderLabelRaw" => "true"]);
                    yield "
                ";
                }
                // line 61
...
";
    ...
    {
        return array (  263 => 66,  257 => 65,  251 => 63,  249 => 62,  246 => 61,  240 => 59,  238 => 58,  233 => 57,  230 => 56,  227 => 55,  223 => 54,  220 => 53,  217 => 51,  213 => 49,  206 => 48,  200 => 46,  198 => 45,  193 => 44,  191 => 43,  188 => 42,  185 => 41,  183 => 40,  181 => 39,  173 => 33,  167 => 31,  164 => 30,  162 => 29,  156 => 27,  154 => 26,  149 => 25,  147 => 24,  132 => 23,  126 => 21,  121 => 19,  118 => 18,  116 => 17,  112 => 16,  109 => 15,  97 => 13,  94 => 12,  92 => 11,  89 => 10,  87 => 9,  85 => 8,  81 => 6,  48 => 1,);
    }
        ...
        {% for subItem in group.items %}
            {% if subItem is iterable and subItem.type is defined %}
                ...
                {% elseif subItem.type == 'header' %}
                    {{ component('ea:ActionMenu:ActionList:Header', { label: (subItem.content|trans), renderLabelRaw: 'true' }) }}
                {% endif %}
            {% else %}
...
", "@EasyAdmin/components/ActionMenu/ActionList/ItemGroup.html.twig", "/Users/julienchassin/Documents/Portfolio/vendor/easycorp/easyadmin-bundle/templates/components/ActionMenu/ActionList/ItemGroup.html.twig");
    }
}
